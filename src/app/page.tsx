          ...
          <Card className="shadow-2xl bg-card/80 backdrop-blur-sm animate-fade-in-up">
            ...
            <CardContent className="space-y-6 px-8 pb-8">
              <p className="text-base md:text-lg text-foreground/80 leading-relaxed font-bold">
                എപ്പോഴും ഇങ്ങനെ സ്ക്രോൾ ചെയ്ത് മടുത്തോ? എന്നാൽ ഈ പരിപാടി ഒന്നു നോക്കിക്കേ. ഇവിടെ പേജ് മാറുന്നത് സ്ക്രോൾ ചെയ്തിട്ടല്ല, മുഖത്തെ എക്സ്പ്രഷൻ വെച്ചിട്ടാ! കഥയിൽ ചിരിക്കേണ്ടപ്പോൾ ചിരിക്കുക, ഞെട്ടേണ്ടപ്പോൾ ഞെട്ടുക... ബാക്കി കാര്യം ഞങ്ങളേറ്റു. സിമ്പിൾ!
              </p>
              <p className="text-base md:text-lg text-foreground/80 leading-relaxed font-bold">
