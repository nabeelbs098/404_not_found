...
export const story: Record<Emotion, StoryPart> = {
  ...
  angry: {
    ...
    text: `എല്ലാവരും തീൻമേശയ്ക്ക് ചുറ്റുമിരിക്കുന്നു. ഭയാനകമായ നിശ്ശബ്ദത. അമൃത വിറയ്ക്കുന്ന കൈകളോടെ എല്ലാവർക്കും സാമ്പാർ വിളമ്പുന്നു. ഊർമിള ദേവി ഒരു തുള്ളി സാമ്പാർ എടുത്ത് രുചിച്ചു നോക്കുന്നു. പെട്ടെന്ന് അവരുടെ മുഖഭാവം മാറുന്നു. ക്യാമറ മൂന്നു തവണ ഊർമിള ദേവിയുടെ മുഖത്തേക്ക് സൂം ചെയ്യുന്ന
